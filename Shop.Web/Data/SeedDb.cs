namespace Shop.Web.Data
{
    ...
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await this.CheckUserAsync("jose.arroyochavez@gmail.com", "Jose", "Arroyo", "Customer");
            await this.CheckUserAsync("je.arroyo.chavez@hotmail.com", "Jose", "Arroyo", "Customer");
            var user = await this.CheckUserAsync("jose.arroyo@bismarck.com.pe", "Jose Emerson", "Arroyo", "Admin");
        ...
        private async Task<User> AddUser(string userName, string firstName, string lastName, string role)
        {
            var user = new User
            {
                ...
                Email = userName,
                UserName = userName,
                Address = "Calle Elias Aguirre 279",
        ...
        private void AddProduct(string name, decimal price, User user)
        {
            this.context.Products.Add(new Product
            {
                ...
                User = user,
                ImageUrl = $"~/images/Products/{name}.jfif"
            });
        }
    }
}
