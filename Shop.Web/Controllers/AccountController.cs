    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterNewUserViewModel model)
        {
            if (this.ModelState.IsValid)
            {
                ...
                if (user == null)
                {
                    ...
                    await this.mailHelper.PostSendMail(model.Username, user.FullName, "Email confirmation", $"<h1>Email Confirmation</h1>" +
                        $"To allow the user, " +
        ...
        public async Task<IActionResult> RecoverPassword(RecoverPasswordViewModel model)
        {
            if (this.ModelState.IsValid)
            {
                ...
                await this.mailHelper.PostSendMail(model.Email, user.FullName, "Shop Password Reset", $"<h1>Shop Password Reset</h1>" +
