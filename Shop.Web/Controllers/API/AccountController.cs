namespace Shop.Web.Controllers.API
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> PostUser([FromBody] NewUserRequest request)
        {
            ...
            await this.mailHelper.PostSendMail(request.Email, user.FullName, "Email confirmation", $"<h1>Email Confirmation</h1>" +
                $"To allow the user, " +
        ...
        [HttpPost]
        [Route("RecoverAPIPassword")]
        public async Task<IActionResult> RecoverAPIPassword([FromBody] RecoverPasswordRequest request)
        {
            if (!ModelState.IsValid)
            {
                return this.BadRequest(new Response
            ...
            await this.mailHelper.PostSendMail(request.Email, user.FullName, "Password Reset", $"<h1>Recover Password</h1>" +
